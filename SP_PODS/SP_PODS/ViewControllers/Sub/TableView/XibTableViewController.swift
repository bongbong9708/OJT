...
class XibTableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Xib TableView"
        ...
        // 테이블뷰에 cell 등록하기
        let nibName = UINib(nibName: "XibTableViewCell", bundle: nil)
        tableView.register(nibName, forCellReuseIdentifier: "xibTableViewCell")
    }

}

extension XibTableViewController: UITableViewDelegate, UITableViewDataSource {
    // 섹션의 수를 지정
